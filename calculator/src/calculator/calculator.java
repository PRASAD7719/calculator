...
public class calculator {
	...
	private void initialize() {
		...
		btnBackspace.setBackground(Color.GREEN);
		btnBackspace.setFont(new Font("Tahoma", Font.BOLD, 22));
		btnBackspace.setBounds(21, 122, 85, 55);
		...
		btnDot.setBounds(116, 427, 85, 55);
		...
		btnClear.setBounds(116, 122, 85, 55);
		...
		btnEqual.setBounds(211, 427, 85, 55);
		...
		btnPluse.setFont(new Font("Tahoma", Font.BOLD, 22));
		btnPluse.setBackground(Color.GREEN);
		btnPluse.setBounds(306, 122, 85, 55);
		...
		btnSub.setBounds(306, 199, 85, 55);
		...
		btnMul.setBounds(306, 275, 85, 55);
		...
		btnDivision.setBackground(Color.GREEN);
		btnDivision.setBounds(306, 352, 85, 55);
		...
		btnPercentage.setFont(new Font("Tahoma", Font.BOLD, 22));
		btnPercentage.setBackground(Color.GREEN);
		btnPercentage.setBounds(306, 427, 85, 55);
